...
module dac_handshake(
    ...
    logic [11:0] transformed_data_in1, transformed_data_in2;

    rom_transform rom_transform1 
                (.clk(clk), 
                .we(1'b0), 
                .addr(data_in1), // <----
                .dout(transformed_data_in1));

    rom_transform rom_transform2 
                (.clk(clk), 
                .we(1'b0), 
                .addr(data_in2), 
                .dout(transformed_data_in2));
    ...
    always_comb begin
        ...
        case(state_r)
            START: begin
                ...
                ready = 1'b1;
                //queueing up getting the transformed
            ...
            TRANSFORM: begin
                next_data_in1 = {4'b0000, transformed_data_in1};
                next_data_in2 = {4'b0000, transformed_data_in2};
                next_state = SEND;
            end
            SEND: begin
