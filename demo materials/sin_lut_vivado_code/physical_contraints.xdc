...
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { laser_en }]; #IO_L7N_T1_34 Sch=ja_n[2]

# bottom half of pins
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { chip_sel }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { data_out1 }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { data_out2 }]; #IO_L22P_T3_34 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { dac_clk }]; #IO_L22N_T3_34 Sch=ja_n[4]
...
# bottom half of pins (Currently Controller)
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { btn[0] }]; #IO_L18P_T2_34 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L18N_T2_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { btn[2] }]; #IO_L4P_T0_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { btn[3] }]; #IO_L4N_T0_34 Sch=jb_n[4]
...
set_property -dict { PACKAGE_PIN U10   IOSTANDARD LVCMOS33 } [get_ports { laser_en }]; # Laser enable pin  #IO_L12N_T1_MRCC_13 Sch=a[5]
